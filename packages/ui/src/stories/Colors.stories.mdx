...
<ColorPalette>
  ...
  <ColorItem title="theme.colors.gradient.secondary" colors={[theme.gradient.secondary]} />
  <ColorItem title="theme.colors.gradient.white" colors={[theme.gradient.white]} />
